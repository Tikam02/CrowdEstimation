...
class MutableModule(BaseModule):
    ...
    def bind(self, data_shapes, label_shapes=None, for_training=True,
        ...
        module = ModuleEXT(self._symbol, self._data_names, self._label_names, logger=self.logger,
    ...
    def forward(self, data_batch, is_train=None):
        ...
        # get input_shapes
        if getattr(data_batch, 'provide_label', None) is not None:
        ...
        if shape_changed:
            module = ModuleEXT(self._symbol, self._data_names, self._label_names,
                            logger=self.logger, context=self._context,
                            work_load_list=self._work_load_list,
                            fixed_param_names=self._fixed_param_names)
            module.bind(data_batch.provide_data, getattr(data_batch, 'provide_label', None), self._curr_module.for_training,
